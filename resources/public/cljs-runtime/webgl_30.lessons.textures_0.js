goog.provide('webgl_30.lessons.textures_0');
goog.require('cljs.core');
goog.require('reagent.core');
goog.require('shadow.resource');
...
webgl_30.lessons.textures_0.initial_state = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"gl","gl",-246422634),null,new cljs.core.Keyword(null,"rect","rect",-108902628),new cljs.core.PersistentArrayMap(null, 8, [new cljs.core.Keyword(null,"translation","translation",-701621547),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(200),(170),(100)], null),new cljs.core.Keyword(null,"rotation","rotation",-1728051644),cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(webgl_30.math.deg__GT_rad,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(190),(40),(320)], null)),new cljs.core.Keyword(null,"scale","scale",-230427353),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(1),(1),(1)], null),new cljs.core.Keyword(null,"rotation-speed","rotation-speed",-637058511),1.2,new cljs.core.Keyword(null,"then","then",460598070),(0),new cljs.core.Keyword(null,"width","width",-384071477),(100),new cljs.core.Keyword(null,"height","height",1025178622),(30),new cljs.core.Keyword(null,"color","color",1011675173),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [0.3,0.3,0.3,(1)], null)], null)], null);
if((typeof webgl_30 !== 'undefined') && (typeof webgl_30.lessons !== 'undefined') && (typeof webgl_30.lessons.textures_0 !== 'undefined') && (typeof webgl_30.lessons.textures_0.state_atom !== 'undefined')){
} else {
webgl_30.lessons.textures_0.state_atom = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(null);
}
if((cljs.core.deref(webgl_30.lessons.textures_0.state_atom) == null)){
cljs.core.reset_BANG_(webgl_30.lessons.textures_0.state_atom,webgl_30.lessons.textures_0.initial_state);
} else {
}
webgl_30.lessons.textures_0.fragment_shader = "precision mediump float;\n\n   varying vec2 v_texcoord;\n\n   // The texture\n   uniform sampler2D u_texture;\n\n   void main() {\n       gl_FragColor = texture2D(u_texture, v_texcoord);\n   }";
webgl_30.lessons.textures_0.vertex_shader = "attribute vec4 a_position;\n   attribute vec2 a_texcoord;\n\n  uniform mat4 u_matrix;\n\n  varying vec2 v_texcoord;\n\n  void main() {\n    gl_Position = u_matrix * a_position;\n\n    // this can be passed to the fragment shader\n    v_texcoord = a_texcoord;\n  }";
webgl_30.lessons.textures_0.multiply_matrices = (function webgl_30$lessons$textures_0$multiply_matrices(p__26311){
...
var rect = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26312__$1,new cljs.core.Keyword(null,"rect","rect",-108902628));
var gl = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26312__$1,new cljs.core.Keyword(null,"gl","gl",-246422634));
var map__26319 = rect;
...
var translation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26319__$1,new cljs.core.Keyword(null,"translation","translation",-701621547));
var scale = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26319__$1,new cljs.core.Keyword(null,"scale","scale",-230427353));
var rotation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26319__$1,new cljs.core.Keyword(null,"rotation","rotation",-1728051644));
...
webgl_30.lessons.textures_0.format = (function webgl_30$lessons$textures_0$format(var_args){
...
args__4795__auto__.push((arguments[i__4790__auto___26414]));

var G__26416 = (i__4790__auto___26414 + (1));
i__4790__auto___26414 = G__26416;
continue;
} else {
}
break;
...
return webgl_30.lessons.textures_0.format.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__4796__auto__);
});

(webgl_30.lessons.textures_0.format.cljs$core$IFn$_invoke$arity$variadic = (function (f,xs){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$4(cljs.pprint.cl_format,null,f,xs);
}));

(webgl_30.lessons.textures_0.format.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(webgl_30.lessons.textures_0.format.cljs$lang$applyTo = (function (seq26331){
var G__26332 = cljs.core.first(seq26331);
var seq26331__$1 = cljs.core.next(seq26331);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26332,seq26331__$1);
}));

webgl_30.lessons.textures_0.draw_BANG_ = (function webgl_30$lessons$textures_0$draw_BANG_(timestamp,state){
var map__26338 = state;
...
var s = map__26338__$1;
var rect = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26338__$1,new cljs.core.Keyword(null,"rect","rect",-108902628));
...
webgl_30.webgl.draw_scene_BANG_(cljs.core.assoc_in(state__$1,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"objects-to-draw","objects-to-draw",1949509717),new cljs.core.Keyword(null,"my-f","my-f",1191307989),new cljs.core.Keyword(null,"uniforms","uniforms",-782808153),new cljs.core.Keyword(null,"u_matrix","u_matrix",1852377410),new cljs.core.Keyword(null,"values","values",372645556)], null),webgl_30.lessons.textures_0.multiply_matrices(state__$1)));

return requestAnimationFrame((function (t){
var G__26340 = t;
var G__26341 = cljs.core.assoc_in(state__$1,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"rect","rect",-108902628),new cljs.core.Keyword(null,"then","then",460598070)], null),now);
return (webgl_30.lessons.textures_0.draw_BANG_.cljs$core$IFn$_invoke$arity$2 ? webgl_30.lessons.textures_0.draw_BANG_.cljs$core$IFn$_invoke$arity$2(G__26340,G__26341) : webgl_30.lessons.textures_0.draw_BANG_.call(null,G__26340,G__26341));
}));
});
webgl_30.lessons.textures_0.raf_draw_BANG_ = (function webgl_30$lessons$textures_0$raf_draw_BANG_(state){
return requestAnimationFrame((function (t){
return webgl_30.lessons.textures_0.draw_BANG_(t,state);
}));
});
webgl_30.lessons.textures_0.setup_BANG_ = (function webgl_30$lessons$textures_0$setup_BANG_(){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(webgl_30.lessons.textures_0.state_atom,(function (p__26347){
...
var state = map__26348__$1;
var gl = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26348__$1,new cljs.core.Keyword(null,"gl","gl",-246422634));
var program = webgl_30.webgl.link_shaders_BANG_(gl,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"fs","fs",-2122926244),webgl_30.lessons.textures_0.fragment_shader,new cljs.core.Keyword(null,"vs","vs",-2022097090),webgl_30.lessons.textures_0.vertex_shader], null));
...
}),new cljs.core.Keyword(null,"source","source",-433931539),webgl_30.core.get_filename(new cljs.core.Var(function(){return webgl_30.lessons.textures_0.state_atom;},new cljs.core.Symbol("webgl-30.lessons.textures-0","state-atom","webgl-30.lessons.textures-0/state-atom",-626992577,null),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"ns","ns",441598760),new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword(null,"file","file",-1269645878),new cljs.core.Keyword(null,"end-column","end-column",1425389514),new cljs.core.Keyword(null,"column","column",2078222095),new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"end-line","end-line",1837326455),new cljs.core.Keyword(null,"arglists","arglists",1661989754),new cljs.core.Keyword(null,"doc","doc",1913296891),new cljs.core.Keyword(null,"test","test",577538877)],[new cljs.core.Symbol(null,"webgl-30.lessons.textures-0","webgl-30.lessons.textures-0",-1305934472,null),new cljs.core.Symbol(null,"state-atom","state-atom",-1350625912,null),"webgl_30/lessons/textures_0.cljs",20,1,19,19,cljs.core.List.EMPTY,null,(cljs.core.truth_(webgl_30.lessons.textures_0.state_atom)?webgl_30.lessons.textures_0.state_atom.cljs$lang$test:null)]))),new cljs.core.Keyword(null,"tutorial-source","tutorial-source",-1194415340),"webgl-3d-textures.html",new cljs.core.Keyword(null,"start","start",-355208981),(function (){
var canvas_id = "texture-0";
var state = cljs.core.deref(webgl_30.lessons.textures_0.state_atom);
var map__26369 = new cljs.core.Keyword(null,"rect","rect",-108902628).cljs$core$IFn$_invoke$arity$1(state);
...
var translation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26369__$1,new cljs.core.Keyword(null,"translation","translation",-701621547));
var scale = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26369__$1,new cljs.core.Keyword(null,"scale","scale",-230427353));
var rotation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26369__$1,new cljs.core.Keyword(null,"rotation","rotation",-1728051644));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(webgl_30.lessons.textures_0.state_atom,cljs.core.assoc,new cljs.core.Keyword(null,"gl","gl",-246422634),webgl_30.webgl.get_context(canvas_id));

webgl_30.lessons.textures_0.setup_BANG_();

return requestAnimationFrame((function (t){
return webgl_30.lessons.textures_0.draw_BANG_(t,cljs.core.deref(webgl_30.lessons.textures_0.state_atom));
}));
})], null)], null)], null);
})], null);
goog.exportSymbol('webgl_30.lessons.textures_0.lesson', webgl_30.lessons.textures_0.lesson);

//# sourceMappingURL=webgl_30.lessons.textures_0.js.map
